...
BD = [[[5], [11, 12, 21, 22, 13, 0], [33, 34, 4, 2], [44, 45, 55, 18, 3], [51, 52, 1, 1]],
      [[3], [21, 22, 32, 0, 1], [13, 23, 2, 2]],
      [[6], [25, 26, 36, 24, 3], [34, 35, 44, 45, 1, 1], [41, 42, 51, 52, 61, 62, 21, 0], [12, 22, 2, 2], [53, 63, 6, 3]]]
...
class TestStringMethods(unittest.TestCase):
    ...
    @unittest.skipUnless(TEST_PROPAGATORS and TEST_ENCODINGS, "Not Testing Propagators and Encodings.")
    def test_props_b1(self):
        board = BD[0]
        self.helper_prop(board, prop_FI)

    @unittest.skipUnless(TEST_PROPAGATORS and TEST_ENCODINGS, "Not Testing Propagators and Encodings.")
    def test_props_b2(self):
        board = BD[1]
        self.helper_prop(board, prop_FI)

    @unittest.skipUnless(TEST_PROPAGATORS and TEST_ENCODINGS, "Not Testing Propagators and Encodings.")
    def test_props_b3(self):
        board = BD[2]
        self.helper_prop(board, prop_FI)
